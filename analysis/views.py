...
def home(request):
    features = [
        {
            "title": "Data Upload",
            "description": "Upload monitoring CSV or Excel files with automatic column detection and validation.",
            "icon": "bi bi-upload",
            "color": "primary",
            "url": "/upload/",
        ...
        {
            "title": "Dashboard",
            "description": "Summarize monitoring performance, profit metrics, and strategy effectiveness.",
...
def simulation_delete_view(request, pk):
    ...
    if request.method == "POST":
        ...
        return redirect("analysis:simulation_history")
